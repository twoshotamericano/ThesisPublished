...
The location of the properties is plotted in Figure \@ref(fig:Intro1) below. I am happy to use a multiple linear regression model to predict house prices. I do not believe we would get a more accurate prediction model by linking response and explanatory variables with something more complicated!! Our key constraint is understanding the data!!
