...
To discover which variables, not included in the data-set, are known to influence property prices I conducted a literature search. To fill these gaps, I performed significant data enrichment.This involved writing custom R code to extract data from online data providers. For local area information, I identified the Google Maps and Google Radar Search API services. For financial information such as rental values, I identified the data services of the Seattle based real estate and rental marketplace [Zillow](https://www.zillow.com/corp/About.htm).  
